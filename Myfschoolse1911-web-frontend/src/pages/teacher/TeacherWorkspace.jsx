...
function Grades({ user, data }) {
  ...
  return (
    <Page title="Quản lý điểm" subtitle="Mỗi đầu điểm có một giá trị và hệ số riêng">
      <Card className="toolbar-card">
        <Picker
          assignments={data.assignments}
          data={data}
...
const DEFAULT_GRADE_ITEMS = [
  { name: 'Kiểm tra 15 phút lần 1', weight: 1 },
  { name: 'Kiểm tra 15 phút lần 2', weight: 1 },
  { name: 'Kiểm tra 45 phút', weight: 2 },
  { name: 'Giữa kỳ', weight: 2 },
  { name: 'Cuối kỳ', weight: 3 },
];
...
function Homeroom({ user, data }) {
  ...
  return (
    <Page title="Công tác chủ nhiệm" subtitle="Xem đơn xin nghỉ, xem điểm tổng hợp và đánh giá học sinh">
      <Card className="toolbar-card">
