...
- Đơn chỉ có một loại cố định `ABSENT`; trạng thái nghiệp vụ duy nhất là `SENT` vì đơn tạo xong chỉ cần giáo viên xem, không cần duyệt.
...
- GVCN chỉ được xem đơn của lớp mình chủ nhiệm, không duyệt/từ chối đơn;
