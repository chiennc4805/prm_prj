...
CREATE TABLE dbo.leave_request (
    ...
    CONSTRAINT CK_leave_status CHECK (status IN ('SENT')),
...
INSERT dbo.grade (student_id, teacher_assignment_id, semester_id, average_score) VALUES
 (1,1,1,8.50), (1,2,1,8.00), (1,3,1,8.50), (1,4,1,7.50),
 (1,5,1,8.22), (1,6,1,8.83), (2,1,1,7.11), (2,2,1,7.83),
 (3,7,1,8.83), (3,8,1,7.83), (5,13,1,9.06), (5,14,1,8.22);

INSERT dbo.grade_item (grade_id,name,score,weight) VALUES
 (1,N'Kiểm tra 15 phút lần 1',8.00,1),(1,N'Kiểm tra 15 phút lần 2',8.50,1),(1,N'Kiểm tra 45 phút',8.00,2),(1,N'Giữa kỳ',8.50,2),(1,N'Cuối kỳ',9.00,3),
 (2,N'Kiểm tra 15 phút lần 1',7.50,1),(2,N'Kiểm tra 15 phút lần 2',8.00,1),(2,N'Kiểm tra 45 phút',7.50,2),(2,N'Giữa kỳ',8.00,2),(2,N'Cuối kỳ',8.50,3),
 (3,N'Kiểm tra 15 phút lần 1',8.50,1),(3,N'Kiểm tra 15 phút lần 2',8.00,1),(3,N'Kiểm tra 45 phút',8.50,2),(3,N'Giữa kỳ',8.00,2),(3,N'Cuối kỳ',9.00,3),
 (4,N'Kiểm tra 15 phút lần 1',7.00,1),(4,N'Kiểm tra 15 phút lần 2',7.50,1),(4,N'Kiểm tra 45 phút',7.00,2),(4,N'Giữa kỳ',7.50,2),(4,N'Cuối kỳ',8.00,3),
 (5,N'Kiểm tra 15 phút lần 1',8.00,1),(5,N'Kiểm tra 15 phút lần 2',8.50,1),(5,N'Kiểm tra 45 phút',8.00,2),(5,N'Giữa kỳ',8.00,2),(5,N'Cuối kỳ',8.50,3),
 (6,N'Kiểm tra 15 phút lần 1',9.00,1),(6,N'Kiểm tra 15 phút lần 2',8.50,1),(6,N'Kiểm tra 45 phút',9.00,2),(6,N'Giữa kỳ',8.50,2),(6,N'Cuối kỳ',9.00,3),
 (7,N'Kiểm tra 15 phút lần 1',7.00,1),(7,N'Kiểm tra 15 phút lần 2',6.50,1),(7,N'Kiểm tra 45 phút',7.00,2),(7,N'Giữa kỳ',7.00,2),(7,N'Cuối kỳ',7.50,3),
 (8,N'Kiểm tra 15 phút lần 1',8.00,1),(8,N'Kiểm tra 15 phút lần 2',7.50,1),(8,N'Kiểm tra 45 phút',8.00,2),(8,N'Giữa kỳ',7.50,2),(8,N'Cuối kỳ',8.00,3),
 (9,N'Kiểm tra 15 phút lần 1',9.00,1),(9,N'Kiểm tra 15 phút lần 2',8.50,1),(9,N'Kiểm tra 45 phút',9.00,2),(9,N'Giữa kỳ',8.50,2),(9,N'Cuối kỳ',9.00,3),
 (10,N'Kiểm tra 15 phút lần 1',7.50,1),(10,N'Kiểm tra 15 phút lần 2',8.00,1),(10,N'Kiểm tra 45 phút',7.50,2),(10,N'Giữa kỳ',8.00,2),(10,N'Cuối kỳ',8.00,3),
 (11,N'Kiểm tra 15 phút lần 1',9.00,1),(11,N'Kiểm tra 15 phút lần 2',9.00,1),(11,N'Kiểm tra 45 phút',9.00,2),(11,N'Giữa kỳ',9.00,2),(11,N'Cuối kỳ',9.17,3),
 (12,N'Kiểm tra 15 phút lần 1',8.00,1),(12,N'Kiểm tra 15 phút lần 2',8.50,1),(12,N'Kiểm tra 45 phút',8.00,2),(12,N'Giữa kỳ',8.00,2),(12,N'Cuối kỳ',8.50,3);
...
INSERT dbo.leave_request (student_id, created_by_id, from_date, to_date, reason, status, reviewed_by_id, reviewed_at, rejection_reason) VALUES
 (1,7,'2026-09-15','2026-09-16',N'Gia đình có việc riêng.','SENT',NULL,NULL,NULL),
 (2,7,'2026-08-25','2026-08-25',N'Khám sức khỏe định kỳ.','SENT',NULL,NULL,NULL),
 (4,8,'2026-09-05','2026-09-07',N'Về quê cùng gia đình.','SENT',NULL,NULL,NULL),
 (6,9,'2026-08-17','2026-08-17',N'Học sinh bị sốt.','SENT',NULL,NULL,NULL);
