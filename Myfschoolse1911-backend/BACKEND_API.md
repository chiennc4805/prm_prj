...
- Các API `/api/teacher/homeroom/**` cũng nhận `teacherId` và kiểm tra đúng GVCN. GVCN chỉ xem đơn xin nghỉ, không có API duyệt/từ chối.
...
- Đơn tạo xong có trạng thái `SENT`; không cần duyệt.
